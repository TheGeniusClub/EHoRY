...
case $1 in
    ...
    11)
    clear; echos "$GR正在解决init.rc已被Magisk修改$RE"; rshy initrc; installer; ends ;;
    12)
    ...
    15)
    clear; echos "$GR正在解决Miscellaneous Check (2)$RE"; rshy initrc; installer; ends ;;
    16)
    ...
    23)
    clear; echos "$GR正在解决Selinux权限泄露问题$RE"; select_modules "2"; ends ;;    
    24)
...
MODULELS=(
        ...
        "2.Zygisk Next 1.3.0 (648)"
        "3.ReZygisk v1.0.0 (425)"
        "4.Treat Wheel v0.0.4"
        "5.NeoZygisk v2.2 (267)"
        "6.Tricky Store v1.4.0 (235)"
        "7.Tricky Store OSS v2.1.0 (69)"
        "8.LSPosed v1.9.2-it (7438)"
...
case $1 in
    ...
    2) mhash="2863b9eb6f526eedf5f625c867fa66dcf3833ab38deec6fa83adfe355a95940e" ;;
    3) mhash="7325cc6ec9f4cde1a36dd89246cceaf9649212459c11d18080ac32a99c9c7991" ;;
    4) mhash="d38a4d0176327ec990c8993bbed84c1bd28820d98443541b40df04fb0d3c3f70" ;;
    5) mhash="418f83b5317016e34cc0bbc669705152f042d9339f6e527fda80e616589604db" ;;
    ...
    8) mhash="64bacde880bd7081af4b5e748c6e8eb4b0bba586c72d30e3ca4ce562363565d5" ;;
...
case $1 in
    ...
    2) share_key="iIAm43ati11i" ;;
    3) share_key="ijnsb3ati0kb" ;;
    4) share_key="inl0b351ibze" ;;
    5) share_key="ipopp3ati0of" ;;
    6) share_key="ixHA439788gh" ;;
    7) share_key="ibCGy353muze" ;;
    8) share_key="iayzu3ati0ta" ;;
...
rshy --download "https://github.com/yu13140/yuhideroot/raw/refs/heads/main/module/peekaboo/Nohello-v1.8.2-48-f824968-release.kpm" "nohello.kpm"
